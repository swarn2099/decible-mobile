...
- [ ] **PASS-07**: Dark mode: dark leather texture, stamps with slight glow. Light mode: cream/lighter, no glow
- [ ] **PASS-08**: "View All Stamps" opens chronological list (most recent first)
